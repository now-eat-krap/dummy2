 ...
 * apilog embed loader
 * -------------------
 * This script is meant to be a single standalone file (embed.js)
...
(function () {
  ...
  function readInitConfigFromScript(el) {
    ...
    var ingestUrl = el.getAttribute("data-ingest-url") || "";
    var pageVariant = el.getAttribute("data-page-variant") || "";

    var utmSource = el.getAttribute("data-utm-source") || "";
    var utmCampaign = el.getAttribute("data-utm-campaign") || "";
